...
data = pd.read_csv('quiz_data.csv', encoding='latin-1')
...
print(b['Element Code'].sort_values())
...
print(data.groupby(['Element','Area']).sum().loc['Protein supply quantity (g/capita/day)']['Y2015'])
...
print(b.sort_values(by='Y2017', ascending=False))